...
# IMG_PREFIX:=wayos-$(BUILD_DATE_PREFIX)
...
sed -i '/IMG_PREFIX_VERCODE:=/a\IMG_PREFIX:=wayos-k6-$(BUILD_DATE_PREFIX)' include/image.mk 
...
sed -i "s/OpenWrt /Way K6 $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" package/lean/default-settings/files/zzz-default-settings
...
sed -i "/exit 0/i sed -i \"\/kiddin9\/d\" \/etc\/opkg\/distfeeds.conf"  package/lean/default-settings/files/zzz-default-settings
sed -i "/exit 0/i sed -i '\/check_signature\/s\/^#\\\?\/# \/'  \/etc\/opkg.conf" package/lean/default-settings/files/zzz-default-settings
...
# Password
sed -i '/\/etc\/shadow/s/^#\?/#/' package/lean/default-settings/files/zzz-default-settings
#sed -i 's/root::0:0:99999:7:::/root:$1$P4yrmMQf$XRoELeUToXNeituE0pl22.:19131:0:99999:7:::/g' package/base-files/files/etc/shadow
sed -i 's/root:::0:99999:7:::/root:$1$G5sZLgNQ$zPKGaik8x2MvYRyzyiPEw\/:19360:0:99999:7:::/g' package/base-files/files/etc/shadow
